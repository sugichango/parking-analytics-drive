...
if "①" in mode:
    ...
    # --- パスだけは絶対的に正しい場所を指定 ---
    file_path = r"C:\Users\sugitamasahiko\Documents\駐車場データ分析試行\Antigravity試行\updated_integrated_data_FY2025.csv.gz"
...
# ==========================================
    ...
    CSV_BASE_DIR = r"C:\Users\sugitamasahiko\Documents\parking_system\data"
